...
def main_loop():
    ...
    while running:
        ...
        strategy_choice = input("Entrez 1, 2 ou 3 (ou 'q' pour quitter) :").strip()
        ...
        try:
            if strategy_choice == "1":
                ...
                print("Stratégie 'tracer_carre' lancée. Appuyez sur ESC pour interrompre...")

                while controleur.strategie:
                    action = affichage.handle_events(adaptateur)
                    if action == "quit" or (action == "automatique" and controleur.strategie):
                ...
                print("Stratégie 'automatique' lancée. Appuyez sur ESC pour interrompre...")
                ...
                print("Stratégie 'vers mur' lancée. Appuyez sur ESC pour interrompre...")
